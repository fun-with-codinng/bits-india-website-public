...
document.getElementById('submitcontactform').addEventListener('click', function (e) {
  e.preventDefault();
  const form = document.forms['contact-form'];
  document.getElementById('submitcontactform').disabled = true;
  
  fetch('https://script.google.com/macros/s/AKfycbx7okqTQ727g_ihSO4F9yG42bsEoZznmd410SCPTOnYoqIHoETTBZMBko0fE9dmUOiX/exec', {
    method: 'POST',
